...
describe('RegisterDestination', () => {
  ...
  test('RegisterDestination page is rendered', async () => {
    ...
    const { getByTestId } = render(<RegisterDestination />);

    const RegisterDestinationContainer = getByTestId('registerDestination');
    expect(RegisterDestinationContainer).toBeInTheDocument();
  });
});
